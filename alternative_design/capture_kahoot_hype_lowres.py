...
3-second deterministic loop at 50 FPS, 960x540 (quarter resolution, 16:9).
"""
import subprocess, os, sys, glob, shutil

# ── CONFIG ──────────────────────────────────────────────────────
WIDTH = 960   # Quarter of 1920
HEIGHT = 540  # Quarter of 1080
FPS = 50
...
OUTPUT_GIF = os.path.join(SCRIPT_DIR, "kahoot_hype_screen_lowres.gif")
FRAME_DIR = "/tmp/wdf_frames_kahoot_hype_lowres"
...
palette = "/tmp/wdf_palette_kahoot_hype_lowres.png"
