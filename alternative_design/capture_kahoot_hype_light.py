#!/usr/bin/env python3
"""Capture Kahoot Hype Screen (Light) via lossless screenshots stitched into a GIF.
3-second deterministic loop at 50 FPS, 1920x1080 (16:9).
"""
...
HTML_PATH = os.path.join(SCRIPT_DIR, "kahoot-hype-screen-light.html")
OUTPUT_GIF = os.path.join(SCRIPT_DIR, "kahoot_hype_screen_light.gif")
FRAME_DIR = "/tmp/wdf_frames_kahoot_hype_light"
...
palette = "/tmp/wdf_palette_kahoot_hype_light.png"
