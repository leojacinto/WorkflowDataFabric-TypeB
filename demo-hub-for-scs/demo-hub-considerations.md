...
Obtain a **Zurich (Alectri)** ![](<../.gitbook/assets/sc_demohub_alectri_category.png>) instance in Demo Hub as your instance for the workshop in your data center of choice. <mark style="color:red;">**Note:**</mark> the workshop labs will only work on a **Zurich (Alectri)** image; selecting any other category will lead to steps not working correctly.
...
<figure><img src="../.gitbook/assets/sc_demohub_manage_instances.png" alt=""><figcaption></figcaption></figure>

4.  In the next screen, click **Request an Instance**.

    <figure><img src="../.gitbook/assets/sc_demohub_request_instance.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/sc_demohub_instance_form.png" alt=""><figcaption></figcaption></figure>
...
6.  See below for a negative scenario where upon selecting <mark style="color:green;">**a.)**</mark> Australia for <mark style="color:green;">**b.)**</mark> Alectri (Zurich), the available instances is <mark style="color:green;">**c.)**</mark> 0.&#x20;
    ...
    <figure><img src="../.gitbook/assets/sc_demohub_no_instances_au.png" alt=""><figcaption></figcaption></figure>
7.  Selecting <mark style="color:green;">**a.)**</mark> **Brazil Data Center Region** then <mark style="color:green;">**b.)**</mark> **Alectri (Zurich)** **Category** in this example, shows that there are 8 instances available. You may have a different experience on instance availability by the time you provision. <mark style="color:green;">**c.)**</mark> **Agree to Terms of Use**. Notice there are <mark style="color:green;">**d.)**</mark> **8** available instances with a **e.)** confirmation of the version you are selecting.
    ...
    <figure><img src="../.gitbook/assets/sc_demohub_instances_available_br.png" alt=""><figcaption></figcaption></figure>
8.  Click on the **Submit** button at the top-right corner of the navigation.

    <figure><img src="../.gitbook/assets/sc_demohub_submit.png" alt=""><figcaption></figcaption></figure>
9.  In less than 10 minutes, you will receive an email indicating that your instance has been provisioned with the instance ID and login details.
    ...
    <figure><img src="../.gitbook/assets/sc_demohub_instance_ready_email.png" alt=""><figcaption></figcaption></figure>
